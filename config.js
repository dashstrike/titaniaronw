...
document.write('<script src="./js/config.js?v=20260918-member-id-links-1"><\/script>');
...
document.write('<script src="./js/member-profile-enhancements.js?v=20260918-name-history-1"><\/script>');
...
document.write('<link rel="stylesheet" href="./css/attendance-page.css?v=20260918-attendance-afk-1">');
