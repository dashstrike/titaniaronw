...
document.write('<script src="./js/config.js?v=20260907-2"><\/script>');
document.write('<script src="./js/job-icons-global.js?v=20260906-3"><\/script>');
...
document.write('<script src="./js/guild-runs-link.js?v=20260907-2"><\/script>');
